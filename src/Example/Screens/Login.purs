...
loginClass :: ∀ props. Redux.ReduxReactClass GlobalState props GlobalState
loginClass = Redux.createClass first spec
  ...
  render dispatch this =
    ...
    where
    render' { isLoggingIn, loginError } state = renderIn DOM.div' do
      div
        ! Props.className "box"
        $ do
          h3
